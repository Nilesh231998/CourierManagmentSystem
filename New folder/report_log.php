...
<?php include('link_display.php');?>
	...
	<?php include('header.php');?>
		...
		<?php
		$q="SELECT Log_ID,CONCAT(e1.first_name,' ',e1.last_name) as name,Remote_IP,User_Type,Login_Time,Logout_Time FROM log as l1, employee as e1 WHERE e1.emp_id = l1.emp_id";
