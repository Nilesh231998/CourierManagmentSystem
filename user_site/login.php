...
if(isset($_REQUEST['btnsubmit']))
{
	...
	$q = "SELECT * FROM clientmast WHERE username = '".$username."' AND password = '".$password."'";
                    ...
                    <div class="row">
						<div class="col col_1">
							...
							<div class="widget-container widget_login">
								...
								<p><label>Username</label><br><input name="txtusername" id="txtusername" class="input" value="" size="20" tabindex="10" type="text"></p>								
								<p><label>Password</label><br><input name="txtpassword" id="txtpassword" class="input" value="" size="20" tabindex="20" type="password"></p>								
								<p class="forget_password"><a href="forgetpassword.php">Forgot Password?</a></p>  
								<div style="color:#FF0000;font-style:oblique;font-size:14px"><?php echo $loginmsg;?></div>								
								<p class="submit">
