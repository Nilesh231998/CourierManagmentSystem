                    ...
                    <div class="row">
						<div class="col col_1">
							...
							<div class="widget-container widget_login">
								...
								<input name="txtfirst_name" id="txtfirst_name" class="input" value="<?php echo $clientrow['first_name'];?>" size="20" tabindex="10" type="text" readonly></p>
								<div id="txtfirst_name1"></div>								
								
								<p><label>Last Name</label><br>
								<input name="txtlast_name" id="txtlast_name" class="input" value="<?php echo $clientrow['last_name'];?>" size="20" tabindex="20" type="text" readonly></p>								
								<div id="txtlast_name1"></div>								
								
								<p><label>Email Id</label><br><input name="txxemail_id" id="txxemail_id" class="input" value="<?php echo $clientrow['email_id'];?>" size="20" tabindex="20" type="text" readonly></p>
								<div id="txxemail_id1"></div>								
								
								<p><label>Contact No</label><br><input name="ttxcontact_no" id="ttxcontact_no" class="input" value="<?php echo $clientrow['contact_no'];?>" size="20" tabindex="20" type="text" readonly></p>																						
							...
							<p><label>COUNTRY NAME</label><br>	
								<select id="cou" class="input" style="width:520px;height:35px;" disabled>
								...
								<select id="state" class="input" style="width:520px;height:35px;" disabled>
							...
							<p><label>CITY NAME</label><br>	
								 <select class="input" name="cmbcity_id" id="cmbcity_id" style="width:520px;height:35px;" disabled>
						...
						<p><label>Address</label><br><textarea class="input" name="xxxaddress" id="xxxaddress" readonly><?php echo $clientrow['address'];?></textarea></p>																						
								<div id="xxxaddress1"></div>	
								<p class="submit">
								<input type="submit" name="btnsubmit" id="btnsubmit" class="btn-submit" value="EDIT" tabindex="100">
								</p>
							  	</form>
							</div>
							<!--/ login widget --> 
