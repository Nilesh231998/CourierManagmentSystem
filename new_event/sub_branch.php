...
<section id="overview" class="parallax-section">
	<div class="container">
		<div class="row">
			<?php 
				$q3 = "SELECT * FROM main_branch WHERE office_id=".$_REQUEST['soid'];
			...
			<div class="wow bounceIn col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-8 text-center">
				<div class="section-title">
					<h2><?php echo $row['office_name'];?></h2>
			...
			$q1="select suboffice_name,contact_no,address from sub_branch where office_id=".$_REQUEST['soid'];
			//echo $q1;
			$cn=getcon();
			...
			<tr>
				<td><?php echo $cnt;?></td>
				<td><?php echo $row1['suboffice_name'];?></td>
